...
return [
    ...
    'backup' => [
        ...
        'source' => [
             ...
             */
            'databases' => [
                env('BACKUP_DATABASE_DRIVER', 'pgsql'),
            ],
        ],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'khalisser@gmail.com'),
        ...
        'discord' => [
            'webhook_url' => 'https://discord.com/api/webhooks/1214782692101595146/b7PxQDR5oIIZ3WjTD3spuBnwRqEGncsm6vMKwJOsT57EVBychMSX248P1DoP453YyXIZ',
